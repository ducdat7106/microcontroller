...
void main(void)
{
    ...
    while(1)
    {
        ...
        PORTB=seg[g];RD0=1;
        _delay((unsigned long)((5)*(8000000/4000.0)));RD0=0;
        PORTB=seg[e];RD7=1;RD1=1;
        _delay((unsigned long)((5)*(8000000/4000.0)));RD1=0;
        PORTB=seg[c];RD2=1;
        _delay((unsigned long)((5)*(8000000/4000.0)));RD2=0;
        PORTB=seg[a];RD3=1;
        _delay((unsigned long)((5)*(8000000/4000.0)));RD3=0;
    }
    return;
}
