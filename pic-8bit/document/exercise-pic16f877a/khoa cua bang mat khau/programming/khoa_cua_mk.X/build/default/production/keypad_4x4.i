...
char Keypad_Scanner()
{
    ...
    if (RB4 == 0) { while (RB4==0) k=1; return '7'; }
    if (RB5 == 0) { while (RB5==0) k=1; return '8'; }
    if (RB6 == 0) { while (RB6==0) k=1; return '9'; }
    if (RB7 == 0) { while (RB7==0) k=1; return '/'; }

    RB0 = 1; RB1 = 0; RB2 = 1; RB3 = 1;
    if (RB4 == 0) { while (RB4==0) k=1; return '4'; }
    if (RB5 == 0) { while (RB5==0) k=1; return '5'; }
    if (RB6 == 0) { while (RB6==0) k=1; return '6'; }
    if (RB7 == 0) { while (RB7==0) k=1; return 'x'; }

    RB0 = 1; RB1 = 1; RB2 = 0; RB3 = 1;
    if (RB4 == 0) { while (RB4==0) k=1; return '1'; }
    if (RB5 == 0) { while (RB5==0) k=1; return '2'; }
    if (RB6 == 0) { while (RB6==0) k=1; return '3'; }
    if (RB7 == 0) { while (RB7==0) k=1; return '-'; }

    RB0 = 1; RB1 = 1; RB2 = 1; RB3 = 0;
    if (RB4 == 0) { while (RB4==0) k=1; return 'C'; }
    if (RB5 == 0) { while (RB5==0) k=1; return '0'; }
    if (RB6 == 0) { while (RB6==0) k=1; return '='; }
    if (RB7 == 0) { while (RB7==0) k=1; return '+'; }
