...
void main(void)
{
    ...
    UART_Write_String("UART Module Initialized and active:\r");
    _delay((unsigned long)((100)*(20000000/4000.0)));
    while(1)
    {
# 60 "main-uart.c"
