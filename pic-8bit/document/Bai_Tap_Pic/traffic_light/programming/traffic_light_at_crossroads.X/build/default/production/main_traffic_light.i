...
# 21 "main_traffic_light.c" 2
# 68 "main_traffic_light.c"
...
void main(void)
{
    ...
    while(1)
    {
        if(PORTAbits.RA0 != macdinh)
        if( !PORTAbits.RA0 )
            normal_state=0;
        macdinh=PORTAbits.RA0;

        if(PORTAbits.RA1 != macdinh)
        if( !PORTAbits.RA1 )
            rush_hour_state=0;
        macdinh=PORTAbits.RA1;

        if(PORTAbits.RA2 != macdinh)
        if( !PORTAbits.RA2 )
            night_state=0;
        macdinh=PORTAbits.RA2;

        if(PORTAbits.RA3 != macdinh)
        if( !PORTAbits.RA3 )
            rain_stare=0;
        macdinh=PORTAbits.RA3;
...
void init_cofig(){
    ...
    TRISCbits.TRISC4=0;
    TRISCbits.TRISC5=0;
    PORTCbits.RC0=PORTCbits.RC3=PORTCbits.RC1=PORTCbits.RC4=PORTCbits.RC2=PORTCbits.RC5=0;
}
...
void rain_mode(int value_ms){
    PORTCbits.RC0 = PORTCbits.RC2 = 0;
    PORTCbits.RC3 = PORTCbits.RC5 = 0;

    PORTCbits.RC1 = PORTCbits.RC4 = 1;
    for(int i=0; i<value_ms; i++)
        _delay((unsigned long)((1)*(16000000/4000.0)));
    PORTCbits.RC1 = PORTCbits.RC4 = 0;
    for(int i=0; i<value_ms; i++)
        _delay((unsigned long)((1)*(16000000/4000.0)));
}
...
void normal_mode(int value){
    ...
    num1=num2=temp1;
    do{
        PORTCbits.RC1=PORTCbits.RC5=1;
        PORTCbits.RC2 = PORTCbits.RC0 = 0;
        PORTCbits.RC4 = PORTCbits.RC3 = 0;
        hienThi();
        num1--;
        num2--;
    ...
    do{
        PORTD = 0xFF;
        PORTCbits.RC3 = PORTCbits.RC2 = 1;
        PORTCbits.RC1 = PORTCbits.RC0 = 0;
    ...
    num1=num2=temp1;
    do{
        PORTCbits.RC4=PORTCbits.RC2=1;
        PORTCbits.RC1 = PORTCbits.RC0 = 0;
        PORTCbits.RC5 = PORTCbits.RC3 = 0;
        hienThi();
        num1--;
        num2--;
    }while(num1 != 0);
