...
void RTC_read()
{
  ...
  I2C_Restart();
  I2C_Write_Char(0xD1);
  second = I2C_Read_Char(); I2C_ACK();
  minute = I2C_Read_Char(); I2C_ACK();
  hour = I2C_Read_Char(); I2C_ACK();
  w_day = I2C_Read_Char(); I2C_ACK();
  m_day = I2C_Read_Char(); I2C_ACK();
  month = I2C_Read_Char(); I2C_ACK();
  year = I2C_Read_Char(); I2C_NACK();
  I2C_Stop();
}
...
void alarms_read_display()
{
  ...
  I2C_Restart();
  I2C_Write_Char(0xD1);
  alarm1_minute = I2C_Read_Char(); I2C_ACK();
  alarm1_hour = I2C_Read_Char(); I2C_ACK();
  I2C_Read_Char(); I2C_ACK();
  alarm2_minute = I2C_Read_Char(); I2C_ACK();
  alarm2_hour = I2C_Read_Char(); I2C_ACK();
  I2C_Read_Char(); I2C_ACK();
  control_reg = I2C_Read_Char(); I2C_ACK();
  status_reg = I2C_Read_Char(); I2C_ACK();
  I2C_Read_Char(); I2C_ACK();
  temperature_msb = I2C_Read_Char(); I2C_ACK();
  temperature_lsb = I2C_Read_Char(); I2C_NACK();
  I2C_Stop();
...
{
  uint8_t j = 0;
  while( j < 100 && (RB1 || i >= 5) && RB2 && (RB3 || i < 5) )
  {
    j++;
...
void main(void)
{
    ...
    if(debounce(1))
    {
      ...
      I2C_Write_Char(0);
      I2C_Write_Char(0);
      I2C_Write_Char(minute);
      I2C_Write_Char(hour);
      I2C_Write_Char(w_day);
      I2C_Write_Char(m_day);
      I2C_Write_Char(month);
      I2C_Write_Char(year);
      I2C_Stop();
    ...
    if(debounce(3))
    {
      ...
      I2C_Write_Char(7);
      I2C_Write_Char(0);
      I2C_Write_Char(alarm1_minute);
      I2C_Write_Char(alarm1_hour);
      I2C_Write_Char(0x80);
      I2C_Write_Char(alarm2_minute);
      I2C_Write_Char(alarm2_hour);
      I2C_Write_Char(0x80);
      I2C_Write_Char(4 | alarm1_status | (alarm2_status << 1));
      I2C_Write_Char(0);
      I2C_Stop();
      _delay((unsigned long)((200)*(8000000/4000.0)));
    }
