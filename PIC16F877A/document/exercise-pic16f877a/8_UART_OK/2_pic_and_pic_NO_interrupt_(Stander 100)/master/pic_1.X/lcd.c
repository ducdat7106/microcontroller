...
void LCD_Init()
{
  ...
  LCD_DATA_PORT_D = 0x00;//Configure data and control bus as output
  LCD_RS_D = 0;
  LCD_EN_D = 0;
...
void LCD_Write_Char(unsigned char Data)
{
  ...
  Low4 = Data & 0x0F;	//Send the Lower Nibble of the Data to LCD
  High4 = Data & 0xF0;	// Send the Higher Nibble of the Data to LCD
