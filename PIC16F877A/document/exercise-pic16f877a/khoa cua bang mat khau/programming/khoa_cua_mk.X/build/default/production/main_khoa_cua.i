...
# 16 "main_khoa_cua.c" 2

# 1 "./eeprom_internal.h" 1
# 15 "./eeprom_internal.h"
...
# 20 "main_khoa_cua.c" 2




char code1[15] ;
char user1[4] = {50, 51, 52, 53};
unsigned char m=0;
int j, cnt = 0;
unsigned char w1;
...
void LOCK_Read()
{
    ...
    user1[0] = EEPROM_Read_Char(0x00);
    _delay((unsigned long)((20)*(16000000/4000.0)));
    user1[1] = EEPROM_Read_Char(0x01);
    _delay((unsigned long)((20)*(16000000/4000.0)));
    user1[2] = EEPROM_Read_Char(0x02);
    _delay((unsigned long)((20)*(16000000/4000.0)));
    user1[3] = EEPROM_Read_Char(0x03);
    _delay((unsigned long)((20)*(16000000/4000.0)));
}
...
{
    _delay((unsigned long)((20)*(16000000/4000.0)));
    EEPROM_Write_Char(0x00,code1[0]);
    _delay((unsigned long)((20)*(16000000/4000.0)));
    EEPROM_Write_Char(0x01,code1[1]);
    _delay((unsigned long)((20)*(16000000/4000.0)));
    EEPROM_Write_Char(0x02,code1[2]);
    _delay((unsigned long)((20)*(16000000/4000.0)));
    EEPROM_Write_Char(0x03,code1[3]);
    _delay((unsigned long)((20)*(16000000/4000.0)));
}
...
void LOCK_Run()
{
 L2: LCD_Clear();
    ...
    if(code1[0] == 43)
    {
        ...
        else if(code1[0]==user1[0] && code1[1]==user1[1] && code1[2]==user1[2] && code1[3]==user1[3] && code1[4]==61)
        {
            LCD_Clear();
            LCD_Set_Cursor(1,4);
